...
/*
 This is an experimental fork of the original `explode` animation that
 ships with liquid-fire. I expect to eventually roll this kind of
 capability back into liquid-fire proper. -ef4
*/
...
function matchAndExplode(context, piece, seen) {
  ...
  context.oldElement.addClass('liquid-animate-old');
  context.newElement.addClass('liquid-animate-new');
  ...
  return Promise.all(hits.map((elt) => {
    ...
    return explodePiece(context, {
      ...
      context.oldElement.removeClass('liquid-animate-old');
      context.newElement.removeClass('liquid-animate-new');
    });
  }));
}
